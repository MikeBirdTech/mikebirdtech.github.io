...
*   `script.js`: Boot animation and the interactive shell
...
- Interactive shell — type `help` at the prompt (commands, tab completion, history, easter eggs)
- CRT scanline effect overlay
- Breathing border glow animation
- Typewriter-style text loading animation (skipped when `prefers-reduced-motion` is set)
